      ...
      <div className='meetteamSection'>
        <Container>
          <div className='max-w-[610px] m-auto flex flex-col pt-[60px] pb-[40px] items-center justify-center text-center'>
            ...
            Were not your average cleantech team. Were a band of specialists united by a mission: to disrupt the energy landscape with ground-breaking fuel cells that generate renewable electricity from wastewater.
